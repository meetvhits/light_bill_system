...
<div class="page-wrapper">
    <div class="container-fluid">
        ...
        @if (session('status'))
            <div class="alert alert-success alert-dismissible alertdash">
            ...
            @elseif(session('fail'))
            <div class="alert alert-warning alert-dismissible alertdash">
                <button type="button" class="btn-close" data-bs-dismiss="alert" class="btn-close"aria-label="Close"> <span aria-hidden="true"></span> </button>
                {{ session('fail') }}
            </div>
        @endif
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                <h3 class="m-b-0">{{ getCustomerCount() }}</h3>
                                <h5 class="text-muted m-b-0">Customers</h5>
                            </div>
                        </div>
                    </div>
                </div>
